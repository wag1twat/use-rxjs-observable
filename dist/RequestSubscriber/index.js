...
var RequestSubscribe = /** @class */ (function (_super) {
    __extends(RequestSubscribe, _super);
    function RequestSubscribe(observer, _a, state) {
        ...
        _this.aborted = false;
        // binding
        _this.requestConfigure = _this.requestConfigure.bind(_this);
        _this.request = _this.request.bind(_this);
        // make axios request on subscription
        new Promise(function (resolve) {
            _this.requestConfigure();
            resolve(_this.request());
        });
        return _this;
    }
    RequestSubscribe.prototype.unsubscribe = function () {
        _super.prototype.unsubscribe.call(this);
        // cancel XHR
        if (this.aborted === false) {
            // @ts-ignore
            axios_1["default"].cancel(this.requestId);
            this.aborted = true;
        }
    };
    return RequestSubscribe;
}(rxjs_1.Subscriber));
exports["default"] = RequestSubscribe;
