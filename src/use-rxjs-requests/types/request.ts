...
export interface RxUseRequestOptions<Data, Error>
...
export interface RxRequestConfigure<Data, Error> {
  (
    configuration: Partial<RxRequestConfig & RxUseRequestOptions<Data, Error>>
  ): void;
}

export type RxUseRequestState<Data, Error> = RxRequestResult<Data, Error>;
